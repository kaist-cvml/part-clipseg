...
class SemanticObjPartDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        if obj_sem_seg_gt is not None:
            ...
            # dataset_dict['ori_obj_part_sem_seg_gt'] = np.array(dataset_dict['ori_obj_part_sem_seg_gt'], dtype=np.int64)
            # dataset_dict['ori_obj_sem_seg_gt'] = np.array(dataset_dict['ori_obj_part_sem_seg_gt'], dtype=np.int64)
