...
evaluator_classes = {
    "CLIPSeg": CLIPSegEvaluator,
    "PartCLIPSeg": PartCLIPSegEvaluator,
}
        ...
        if evaluator_type in ["sem_seg", "ade20k_panoptic_seg"]:
            ...
            evaluator_list.append(
                evaluator(
                    ...
                    ORACLE=cfg.ORACLE if hasattr(cfg, "ORACLE") else False,
                    visualize=cfg.TEST.VISUALIZE if hasattr(cfg.TEST, "VISUALIZE") else False,
                    visualize_attn=cfg.TEST.VISUALIZE_ATTN if hasattr(cfg.TEST, "VISUALIZE_ATTN") else False,
                )
            )
