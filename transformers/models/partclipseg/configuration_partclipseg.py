...
""" PartCLIPSeg model configuration"""
...
PARTCLIPSEG_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "CIDAS/clipseg-rd64": "https://huggingface.co/CIDAS/clipseg-rd64/resolve/main/config.json",
}


class PartCLIPSegTextConfig(PretrainedConfig):
    r"""
...
class PartCLIPSegVisionConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`CLIPSegModel`]. It is used to instantiate an
    CLIPSeg model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the CLIPSeg
...
class PartCLIPSegConfig(PretrainedConfig):
    r"""
    [`PartCLIPSegConfig`] is the configuration class to store the configuration of a [`CLIPSegModel`]. It is used to
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if text_config_dict is not None:
            ...
            _text_config_dict = PartCLIPSegTextConfig(**text_config_dict).to_dict()
        ...
        if vision_config_dict is not None:
            ...
            _vision_config_dict = PartCLIPSegVisionConfig(**vision_config_dict).to_dict()
        ...
        self.text_config = PartCLIPSegTextConfig(**text_config)
        self.vision_config = PartCLIPSegVisionConfig(**vision_config)

        self.architectures = ['PartCLIPSegForImageSegmentation']
    ...
    @classmethod
    def from_text_vision_configs(cls, text_config: PartCLIPSegTextConfig, vision_config: PartCLIPSegVisionConfig, **kwargs):
        r"""
