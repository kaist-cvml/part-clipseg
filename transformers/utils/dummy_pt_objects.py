...
PARTCLIPSEG_PRETRAINED_MODEL_ARCHIVE_LIST = None


class PartCLIPSegForImageSegmentation(metaclass=DummyObject):
    _backends = ["torch"]
...
class PartCLIPSegModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class PartCLIPSegPreTrainedModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class PartCLIPSegTextModel(metaclass=DummyObject):
    _backends = ["torch"]
...
class PartCLIPSegVisionModel(metaclass=DummyObject):
    _backends = ["torch"]
